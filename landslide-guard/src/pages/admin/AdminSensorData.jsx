...
import { sensorCards, riskZones } from "../../data/mockData";
import { FiCloudRain, FiDroplet, FiThermometer, FiTrendingDown } from "react-icons/fi";
  ...
  return (
    <div className="space-y-8">
      <SectionHeader
        ...
        title="Sensor Data"
        description="Real-time readings aggregated from field sensor clusters across active zones (last 6 hours)."
      />
